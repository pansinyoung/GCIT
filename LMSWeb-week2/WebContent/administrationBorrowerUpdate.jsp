...
<div class="container theme-showcase" role="main">
	...
	<div class="col-md-6" align="right">
		<form class="form-inline"
			action="searchBorrower?pageNo=<%=pageNo%>&pageSize=<%=pageSize%>"
			method="get">
			<div class="row">
		...
		<div class="col-lg-10" align="center" style="float: right;">
			...
			<table class="table table-striped" style="text-align: center;">
				...
				<tr>
					...
					href='borrowerupdate.jsp?borrowerId=<%=b.getCardNo()%>' >Update</button></td>
			...
			<nav aria-label="Page navigation">
				<ul class="pagination">
					...
					%>
					<li><a
						href="administrationBorrowerUpdate?pageNo=<%=(pageNo - 1)%>&pageSize=<%=pageSize%> "
					...
					%>
					<li><a
						href="administrationBorrowerUpdate?pageNo=<%=i%>&pageSize=<%=pageSize%>"><%=i%></a></li>
					<%
						}
					...
					%>
					<li><a
						href="searchBorrowerUpdate?searchString=<%=searchString%>&pageNo=<%=(pageNo - 1)%>&pageSize=<%=pageSize%>"
						aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
					</a></li>
					<%
						}
					...
					%>
					<li><a
						href="searchBorrowerUpdate?searchString=<%=searchString%>&pageNo=<%=i%>&pageSize=<%=pageSize%>"><%=i%></a></li>
					<%
						}
							if (pageNo != totalPages) {
					%>
