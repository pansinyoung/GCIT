...
<%
	...
	int pageNo = 1;
	int pageSize = 10;
	String searchString = "Search borrower!";
	...
	if (request.getAttribute("borrowers") != null) {
		...
		borrowers = adminService.readAllBorrower(1, 10);
		totalPages = adminService.getAllCountBorrower();
	}
...
<div class="container theme-showcase" role="main">
	...
	<div class="col-md-6" align="right">
		<form class="form-inline"
			action="searchBorrowerDelete?pageNo=<%=pageNo%>&pageSize=<%=pageSize%>"
			method="get">
			<div class="row">
		...
		<div class="col-lg-10" align="center" style="float: right;">
			...
			<table class="table table-striped" style="text-align: center;">
				<tr style="text-align: center;">
					...
					<th style="text-align: center;">Borrower Address</th>
					<th style="text-align: center;">Borrower Phone</th>
				...
				<tr>
					...
					<td><button class="btn btn-sm btn-danger"
							onclick="javascript:location.href='administrationBorrowerDelete?borrowerId=<%=b.getCardNo()%>'">Delete</button></td>
			...
			<nav aria-label="Page navigation">
				<ul class="pagination">
					<%
						if (searchString == "Search borrower!") {
							if (pageNo != 1) {
					%>
					<li><a
						href="administrationBorrowerDelete?pageNo=<%=(pageNo - 1)%>&pageSize=<%=pageSize%> "
					...
					%>
					<li><a
						href="administrationBorrowerDelete?pageNo=<%=i%>&pageSize=<%=pageSize%>"><%=i%></a></li>
					<%
						}
					...
					%>
					<li><a
						href="searchBorrowerDelete?searchString=<%=searchString%>&pageNo=<%=(pageNo - 1)%>&pageSize=<%=pageSize%>"
						aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
					</a></li>
					<%
						}
					...
					%>
					<li><a
						href="searchBorrowerDelete?searchString=<%=searchString%>&pageNo=<%=i%>&pageSize=<%=pageSize%>"><%=i%></a></li>
					<%
						}
							if (pageNo != totalPages) {
					%>
