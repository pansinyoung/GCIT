		...
		<div class="col-lg-10" align="center" style="float: right;">
			...
			<nav aria-label="Page navigation">
				<ul class="pagination">
					...
					%>
					<li><a
						href="administrationBranch?pageNo=<%=(pageNo - 1)%>&pageSize=<%=pageSize%> "
					...
					%>
					<li><a
						href="administrationBranch?pageNo=<%=i%>&pageSize=<%=pageSize%>"><%=i%></a></li>
					<%
						}
					...
					%>
					<li><a
						href="searchBranch?searchString=<%=searchString%>&pageNo=<%=(pageNo - 1)%>&pageSize=<%=pageSize%>"
						aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
					</a></li>
					<%
						}
					...
					%>
					<li><a
						href="searchBranch?searchString=<%=searchString%>&pageNo=<%=i%>&pageSize=<%=pageSize%>"><%=i%></a></li>
					<%
						}
							if (pageNo != totalPages) {
					%>
