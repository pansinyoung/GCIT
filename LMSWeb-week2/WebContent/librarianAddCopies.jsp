					...
					<div class="panel-heading">
						<h4 class="panel-title myCollapseItem myCollapseItem">
							<a data-toggle="collapse" data-parent="#accordion"
								href="#collapse1">Librian</a>
						</h4>
					</div>
					<div id="collapse1" class="panel-collapse collapse in">
						<div class="list-group">
							<a class="panel-collapse collapse">Librian</a> 
			...
			<table class="table table-striped" style="text-align: center;">
				...
				<%
					for (Branch b : branches) {
						List<BookCopies> copies = service.readCopiesByBranchId(b.getBranchId());
				%>
				<tr>
						...
						<div class="col-sm-1">
							<div class="dropdown" style="width: 200px;">
								<button class="btn btn-info dropdown-toggle" type="button"
									...
									Copies <span class="caret"></span>
								</button>
								<ul class="dropdown-menu">
									<%
										if (copies == null || copies.isEmpty()) {
									%>
									<li><a>No copies in this branch</a></li>
									<%
										} else {
									%>
									<%
										for (BookCopies a : copies) {
									%>
									<li><%="BookId: "+a.getBook().getBookId()+" Num:"+a.getNoOfCopies()%></li>
									<%
										}
											}
									%>
					...
					href='branchaddcopies.jsp?branchId=<%=b.getBranchId()%>' >Add Copies</button></td>
				</tr>
				<%
					}
				%>
