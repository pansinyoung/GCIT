...
<%
	...
	int pageNo = 1;
	int pageSize = 10;
	String searchString = "Search genre!";
	...
	if (request.getAttribute("genres") != null) {
		...
		genres = adminService.readAllGenre(1, 10);
		totalPages = adminService.getAllCountGenre();
	}
...
<div class="container theme-showcase" role="main">
	...
	<div class="col-md-6" align="right">
		<form class="form-inline"
			action="searchGenre?pageNo=<%=pageNo%>&pageSize=<%=pageSize%>"
			method="get">
			<div class="row">
			...
			<div class="panel-group" id="accordion">
				<div class="panel panel-default panel-info">
					...
					<div id="collapse1" class="panel-collapse collapse">
						<div class="list-group">
							<a class="panel-collapse collapse">Book</a> <a href="bookadd.jsp"
								class="list-group-item" data-toggle="modal"
								data-target="#bookOps">Add</a> <a
								href="administrationBookDelete.jsp" class="list-group-item">Delete</a>
				...
				<div class="panel panel-default panel-info">
					...
					<div id="collapse2" class="panel-collapse collapse">
						<div class="list-group">
							<a class="panel-collapse collapse">Author</a> <a
								href="authoradd.jsp" class="list-group-item" data-toggle="modal"
								data-target="#bookOps">Add</a> <a
								href="administrationAuthorDelete.jsp" class="list-group-item">Delete</a>
				...
				<div class="panel panel-default panel-info">
					...
					<div id="collapse3" class="panel-collapse collapse">
						<div class="list-group">
							<a class="panel-collapse collapse">Publisher</a> <a
								href="publisheradd.jsp" class="list-group-item"
								data-toggle="modal" data-target="#bookOps">Add</a> <a
								href="administrationPublisherDelete.jsp" class="list-group-item">Delete</a>
							<a href="administrationPublisherUpdate.jsp"
								class="list-group-item">Update</a> <a
								href="administrationPublisher.jsp" class="list-group-item">View</a>
						</div>
					</div>
				</div>
				<div class="panel panel-default panel-info">
					...
					<div id="collapse4" class="panel-collapse collapse">
						<div class="list-group">
							<a class="panel-collapse collapse">Branch</a> <a
								href="branchadd.jsp" class="list-group-item" data-toggle="modal"
								data-target="#bookOps">Add</a> <a
								href="administrationBranchDelete.jsp" class="list-group-item">Delete</a>
				...
				<div class="panel panel-default panel-info">
					...
					<div id="collapse5" class="panel-collapse collapse">
						<div class="list-group">
							<a class="panel-collapse collapse">Borrower</a> <a
								href="borroweradd.jsp" class="list-group-item"
								data-toggle="modal" data-target="#bookOps">Add</a> <a
								href="administrationBorrowerDelete.jsp" class="list-group-item">Delete</a>
							<a href="administrationBorrowerUpdate.jsp"
								class="list-group-item">Update</a> <a
								href="administrationBorrower.jsp" class="list-group-item">View</a>
						</div>
					</div>
				</div>
				<div class="panel panel-default panel-info">
					...
					<div id="collapse6" class="panel-collapse collapse in">
						<div class="list-group">
							<a class="panel-collapse collapse">Genre</a> <a
								href="genreadd.jsp" class="list-group-item" data-toggle="modal"
								data-target="#bookOps">Add</a> <a
								href="administrationGenreDelete.jsp" class="list-group-item">Delete</a>
		...
		<div class="col-lg-10" align="center" style="float: right;">
			...
			<table class="table table-striped" style="text-align: center;">
				<tr style="text-align: center;">
					...
					<%
						for (Genre b : genres) {
							List<Book> books = adminService.viewGenreBook(b.getGenreId());
					%>
				
				<tr>
					<td><%=genres.indexOf(b) + 1%></td>
					...
					<td><button class="btn btn-sm btn-danger"
							onclick="javascript:location.href='administrationGenreDelete?genreId=<%=b.getGenreId()%>'">Delete</button></td>
			...
			<nav aria-label="Page navigation">
				<ul class="pagination">
					<%
						if (searchString == "Search genre!") {
							if (pageNo != 1) {
					%>
					<li><a
						href="administrationGenreDelete?pageNo=<%=(pageNo - 1)%>&pageSize=<%=pageSize%> "
					...
					%>
					<li><a
						href="administrationGenreDelete?pageNo=<%=i%>&pageSize=<%=pageSize%>"><%=i%></a></li>
					<%
						}
					...
					%>
					<li><a
						href="searchGenreDelete?searchString=<%=searchString%>&pageNo=<%=(pageNo - 1)%>&pageSize=<%=pageSize%>"
						aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
					</a></li>
					<%
						}
					...
					%>
					<li><a
						href="searchGenreDelete?searchString=<%=searchString%>&pageNo=<%=i%>&pageSize=<%=pageSize%>"><%=i%></a></li>
					<%
						}
							if (pageNo != totalPages) {
					%>
