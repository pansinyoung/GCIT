...
<div class="container theme-showcase" role="main">
	...
	<div class="col-md-6" align="right">
		<form class="form-inline"
			action="searchAuthorsUpdate?pageNo=<%=pageNo%>&pageSize=<%=pageSize%>"
			method="get">
			<div class="row">
		...
		<div class="col-lg-10" align="center" style="float: right;">
			...
			<table class="table table-striped" style="text-align: center;">
				...
				<tr>
					...
					href='authorupdate.jsp?authorId=<%=a.getAuthorId()%>'>Update</button></td>
				</tr>
				<%
					}
				%>
			...
			<nav aria-label="Page navigation">
				<ul class="pagination">
					...
					%>
					<li><a
						href="administrationAuthorUpdate?pageNo=<%=(pageNo - 1)%>&pageSize=<%=pageSize%> "
					...
					%>
					<li><a
						href="administrationAuthorUpdate?pageNo=<%=i%>&pageSize=<%=pageSize%>"><%=i%></a></li>
					<%
						}
					...
					%>
					<li><a
						href="searchAuthorsUpdate?searchString=<%=searchString%>&pageNo=<%=(pageNo - 1)%>&pageSize=<%=pageSize%>"
						aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
					</a></li>
					<%
						}
					...
					%>
					<li><a
						href="searchAuthorsUpdate?searchString=<%=searchString%>&pageNo=<%=i%>&pageSize=<%=pageSize%>"><%=i%></a></li>
					<%
						}
							if (pageNo != totalPages) {
					%>
